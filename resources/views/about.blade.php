<x-layout :title="$title">
    ...
    <div class="flex items-center justify-center h-48 mb-4 rounded-sm">
        <h1 class="text-3xl font-bold text-gray-800 dark:text-white">Tentang Kami</h1>
    </div>
    ...
    <section class="max-w-5xl mx-auto px-4 py-8 bg-white dark:bg-gray-900 rounded-lg  my-5">
        <div class="grid md:grid-cols-2 gap-6">
            <div>
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">Siapa Kami?</h2>
            ...
            <div>
                <h2 class="text-2xl font-semibold text-gray-800 dark:text-white mb-4">Apa yang Kami
                    Lakukan?</h2>
        ...
        <!-- Core Values -->
        <div class="mt-10">
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-3">Nilai-Nilai Perusahaan</h3>
            <div class="grid md:grid-cols-3 gap-4">
                <div class="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow">
                    <h4 class="font-bold text-lg text-primary-600 dark:text-primary-400">
                        Profesionalisme</h4>
                ...
                <div class="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow">
                    <h4 class="font-bold text-lg text-primary-600 dark:text-primary-400">Inovasi
                    </h4>
                    <p class="text-sm mt-1 text-gray-600 dark:text-gray-300">
                ...
                <div class="p-4 bg-gray-100 dark:bg-gray-800 rounded-lg shadow">
                    <h4 class="font-bold text-lg text-primary-600 dark:text-primary-400">Kolaborasi
                    </h4>
                    <p class="text-sm mt-1 text-gray-600 dark:text-gray-300">
